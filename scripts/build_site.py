...
<html lang="en">
  ...
  <body>
    ...
    <aside class="control-panel ui-panel" id="panel-controls" data-panel-id="controls">
      <div class="panel-header">
        <h1 class="panel-title">SIENA Flood Maps</h1>
        <button
          type="button"
          class="panel-toggle"
          aria-expanded="true"
          aria-controls="panel-controls-body"
          aria-label="Toggle controls panel"
        >
          <span class="panel-toggle-icon" aria-hidden="true">▾</span>
        </button>
      </div>
      <div id="panel-controls-body" class="panel-body">
        <p class="demo-note">
    ...
    <section class="legend ui-panel" id="panel-legend" data-panel-id="legend" aria-label="Class legend">
      <div class="panel-header">
        ...
        <button
          ...
          class="panel-toggle"
          aria-expanded="true"
          aria-controls="panel-legend-body"
          aria-label="Toggle legend"
        >
          <span class="panel-toggle-icon" aria-hidden="true">▾</span>
        </button>
      </div>
      <div id="panel-legend-body" class="panel-body">
    ...
    <section class="map-tools ui-panel" id="panel-tools" data-panel-id="tools" aria-label="Map scale and zoom">
      <div class="panel-header">
        <h2 class="panel-title">Map tools</h2>
        <button
          type="button"
          class="panel-toggle"
          aria-expanded="true"
          aria-controls="panel-tools-body"
          aria-label="Toggle map tools"
        >
          <span class="panel-toggle-icon" aria-hidden="true">▾</span>
        </button>
      </div>
      <div id="panel-tools-body" class="panel-body">
    ...
    <div class="mobile-fab" id="mobile-fab" hidden>
      <div class="fab-menu" id="fab-menu" role="menu" aria-label="Map panels" hidden>
        <button type="button" class="fab-menu-item" data-panel-id="controls" role="menuitem">Controls</button>
        <button type="button" class="fab-menu-item" data-panel-id="legend" role="menuitem">Legend</button>
        <button type="button" class="fab-menu-item" data-panel-id="tools" role="menuitem">Scale</button>
      </div>
      <button
        type="button"
        class="fab-main"
        ...
        aria-label="Open map tools menu"
      >
        Tools
      </button>
    </div>
    <button type="button" class="mobile-backdrop" id="mobile-backdrop" hidden aria-label="Close panel"></button>
